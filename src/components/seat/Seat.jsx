        ...
        <div className='space-y-5'>
            ...
            <div className="w-full flex justify-between">
                    ...
                    <div className="w-full flex-1 flex gap-x-5 items-stretch">
                        ...
                        <div className="flex flex-col items-center">
                            <div className="flex-1 space-y-4">
                                ...
                                <div className="w-full grid grid-cols-10 gap-x-3"><div className="col-span-9"></div>{seats.slice(20, 21)}</div>
                ...
                <div className="space-y-3 w-28">
                    ...
                    <div className="flex items-center gap-x-2">
                        ...
                        <p className="text-neutral-900 dark:text-neutral-200 text-sm font-normal">$ 750</p>
                    </div>
                </div>
            </div>
            ...
            {selectedSeats.length > 0 && (
                <div className='!mt-5 flex items-center gap-x-4'>
                    ...
                    <span className="text-sm text-neutral-400 dark:neutral-600 font-normal">(Including all taxes)</span>
                </div>
            )}
        </div>
    );
