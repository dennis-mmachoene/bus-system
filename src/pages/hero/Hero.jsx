...
const Hero = () => {
    ...
    const imageVariants = {
        ...
        animate: {
            x: '3%', // Move to the intended position
            transition: {
                duration: 3,
                ease: 'easeInOut'
            }
            ...
            <div className="flex-1 w-full flex items-stretch justify-between gap-12 pb-10">
                ...
                >
                    ...
                    >
                        ...
                        >
                            Reserve Your Bus{' '} <span className="text-violet-400 tracking-wider">Seat</span>{' '} Now
                        </motion.h1>
                        <motion.p className='text-lg font-normal text-neutral-50 line-clamp-3 text-ellipsis'
                            ...
                            Find and book your bus seat with just a few clicks. We offer a wide range of bus routes and schedules to suit your needs.
                        </motion.p>
                    </motion.div>
                ...
                <div className="w-[70%] h-full rounded-md flex items-end justify-end absolute top-0 -right-48">
                    <motion.img className='w-full aspect-[4/2] object-contain' alt='Bus Image' src={Bus2}
                        initial='initial'
                        animate='animate'
